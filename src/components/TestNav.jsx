...
const TestNav = () => {
  ...
  <Link to='/Map'>
  <div className="pl-28 pr-0 md:pr-[150px] text-white hover:underline md:text-sm md:font-medium text-[18.83px] font-normal font-['Magical Stylish Sans Serif Demo']">Home</div>
  </Link> 
</nav>
  );
};
